...
namespace hagen
{
    class FileLocation
    {
        ...
        public static FileLocation Parse(string spec)
        {
            ...
            return candidates.FirstOrDefault(i => i != null && new FileSystemInfo(i.Path.Long()).Exists);
        }
        ...
        public class Test
        {
            ...
            {
                var p = FileLocation.PathPattern;
                var re = new Regex(p);
                Console.WriteLine(re.ToString().EscapeCsharpStringLiteral());
            }
        }
    }
}
